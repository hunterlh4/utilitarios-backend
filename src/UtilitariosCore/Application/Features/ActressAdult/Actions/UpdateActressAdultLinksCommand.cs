...
public record UpdateActressAdultLinksCommand(int Id, List<string> Links) : IRequest<Result>
{
    public sealed class Validator : AbstractValidator<UpdateActressAdultLinksCommand>
    {
        public Validator()
        {
    ...
    internal sealed class Handler(
        ...
        : IRequestHandler<UpdateActressAdultLinksCommand, Result>
    {
        public async Task<Result> Handle(UpdateActressAdultLinksCommand request, CancellationToken cancellationToken)
        {
            ...
            var existingLinks = await linkRepository.GetLinksByRefId(request.Id, LinkType.ActressAdult);
