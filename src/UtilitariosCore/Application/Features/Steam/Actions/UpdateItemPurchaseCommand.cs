...
public record UpdateItemPurchaseCommand(int Id) : IRequest<Result>
{
...
internal sealed class UpdateSteamItemPurchaseCommandHandler(
    ...
    : IRequestHandler<UpdateItemPurchaseCommand, Result>
{
    public async Task<Result> Handle(UpdateItemPurchaseCommand request, CancellationToken cancellationToken)
    {
