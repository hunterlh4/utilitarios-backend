using BackofficeCore.Domain.Dtos.Queue;
using BackofficeCore.Domain.Interfaces;
using BackofficeCore.Infrastructure.Queue;
using BackofficeCore.Infrastructure.Settings;
using Microsoft.Extensions.Options;

namespace BackofficeCore.Infrastructure.Services.Notifications;
